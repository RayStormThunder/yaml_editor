...
def detailed_to_simple(detailed_data, base_game):
    simple_data = {
        ...
        "description": detailed_data.get("description", "Generated by RayStormThunder's YAML Editor"),
...
def simple_to_detailed(simple_data, base_data, base_game):
    detailed_data = {
        ...
        "description": simple_data.get("description", "Generated by RayStormThunder's YAML Editor"),
